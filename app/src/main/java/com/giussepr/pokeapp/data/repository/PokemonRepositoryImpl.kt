...
class PokemonRepositoryImpl @Inject constructor(
    ...
    override fun getPokemonStats(pokemonId: Int): Flow<Result<List<PokemonStat>>> = flow {
    ...
    override fun getPokemonMoves(pokemonId: Int): Flow<Result<List<PokemonMove>>> = flow {
